...
# Mock data for testing (replace with real MongoDB later)
mock_users = {
    'test_user_id': {
        '_id': 'test_user_id',
        'name': 'Test User',
...
if __name__ == '__main__':
    ...
    print("1. Visit http://localhost:5003/debug/email to check email config")
    print("2. Get token: curl -X POST http://localhost:5003/test-token")
    print("3. Test booking: curl -X POST http://localhost:5003/api/bookings/request \\")
    print("   -H 'Authorization: Bearer YOUR_TOKEN' \\")
    print("   -H 'Content-Type: application/json' \\")
    print("   -d '{\"hostel_id\":\"test_hostel_id\",\"room_id\":\"double_regular\",\"property_type\":\"Double Sharing\",\"facility\":\"Regular\"}'")
